...
\section{Using the Date and Dateline templates}
...
\begin{verbatim}
{{dateline|date=January 1, 2005|location=Mumbai, India}} Massive 
floods soaked ...
\end{verbatim}
...
An exception for times of exactly 12 noon are called ``noon'' and 12 midnight are called ``midnight.'' Neither are referred to as ``12:00 a.m.'' or ``12:00 p.m.''
...
The Wikinews \texttt{\{\{date\}\}} and \texttt{\{\{dateline\}\}} templates automatically add the date category to your article, linking it to a list of all articles from that date.
